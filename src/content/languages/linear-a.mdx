...
- **Relation to Linear B:** Linear B was adapted from Linear A, so many signs share similar shapes — but the underlying languages are different
</Cited>
...
- The corpus is small and primarily administrative, limiting contextual clues
</Cited>

## Sample Inscription

<Cited status="red">
From a libation table at the peak sanctuary of Psychro (GORILA transcription):
</Cited>
