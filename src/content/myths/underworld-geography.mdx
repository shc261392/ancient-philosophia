...
<Cited status="yellow">
The Mesopotamian underworld was the most pessimistic afterworld in the ancient Near East:
</Cited>
...
- A vast subterranean realm beneath the **Abzu** (underground freshwater ocean), reached through seven gates
</Cited>
...
- The quality of afterlife depended primarily on **proper burial** and **funerary offerings** from living descendants<Ref id={3} />
</Cited>

## Egypt: The Duat and the Field of Reeds

<Cited status="yellow">
The Egyptian afterlife was the most elaborate and optimistic in the ancient world:
</Cited>

### The Night Journey
<Cited status="yellow">
The **Duat** (𓂧𓂧𓇳𓏏) was the underworld through which the **sun god Ra** traveled during the twelve hours of the night. The dead joined this journey, encountering demons, gates, and trials.
</Cited>
...
- Heart heavy with sin → devoured by **Ammit** → the "second death" (total annihilation)<Ref id={4} />
</Cited>
...
### Geography
<Cited status="green">
The Greek underworld was ruled by **Hades** (Ἅιδης, "The Unseen") and his queen **Persephone**. Its geography emerged gradually:<Ref id={5} />
</Cited>
...
- **Plato**: Introduced philosophical judgment — the soul judged by Minos, Rhadamanthys, and Aeacus; a cycle of reincarnation for most; permanent bliss or punishment for the extreme cases<Ref id={6} />
</Cited>
...
<Cited status="green">
Virgil's ***Aeneid*** Book 6 provides the fullest Roman underworld geography: Aeneas descends through the Cumaean cave, passes through the Mourning Fields and Fields of War, reaches Tartarus (which he does not enter), and finally arrives at Elysium to meet his father Anchises, who reveals Rome's future destiny.<Ref id={7} />
</Cited>
...
<References references={[
  { id: 1, text: "Bernstein, Alan E. The Formation of Hell: Death and Retribution in the Ancient and Early Christian Worlds. Cornell University Press, 1993." },
  { id: 2, text: "Dalley, Stephanie, trans. Myths from Mesopotamia: Creation, the Flood, Gilgamesh, and Others. Rev. ed. Oxford World's Classics, 2000, pp. 154–162.", url: "https://doi.org/10.1093/owc/9780199538362.001.0001" },
  { id: 3, text: "Katz, Dina. The Image of the Netherworld in the Sumerian Sources. CDL Press, 2003." },
  { id: 4, text: "Hornung, Erik. The Ancient Egyptian Books of the Afterlife. Trans. David Lorton. Cornell University Press, 1999, pp. 1–25." },
  { id: 5, text: "Garland, Robert. The Greek Way of Death. 2nd ed. Cornell University Press, 2001." },
  { id: 6, text: "Bremmer, Jan N. The Rise and Fall of the Afterlife. Routledge, 2002, pp. 1–55.", url: "https://doi.org/10.4324/9780203467800" },
  { id: 7, text: "Virgil, Aeneid 6. Commentary: Austin, R. G. Aeneidos Liber Sextus. Oxford University Press, 1977." },
]} />
