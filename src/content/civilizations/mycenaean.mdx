...
<References references={[
  { id: 1, text: "*John Chadwick, The Mycenaean World*** — Classic introduction by Ventris's collaborator" },
  { id: 2, text: "*Eric Cline, 1177 B.C.: The Year Civilization Collapsed*** — The Bronze Age collapse in full context" },
  { id: 3, text: "*Cynthia Shelmerdine (ed.), The Cambridge Companion to the Aegean Bronze Age*** — Comprehensive academic survey" },
  { id: 4, text: "Iklaina Archaeological Project — Important ongoing Mycenaean excavation", url: "http://www.iklaina.org/" },
  { id: 5, text: "DAMOS Database of Mycenaean at Oslo — Searchable Linear B database", url: "https://damos.hf.uio.no/" },
]} />