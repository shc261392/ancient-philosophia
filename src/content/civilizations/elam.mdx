...
<References references={[
  { id: 1, text: "*D.T. Potts, The Archaeology of Elam: Formation and Transformation of an Ancient Iranian State*** — The definitive archaeological study" },
  { id: 2, text: "*Javier Álvarez-Mon et al. (eds.), The Elamite World*** — Comprehensive modern survey" },
  { id: 3, text: "Louvre Museum, Susa collections — Home to many key Elamite artifacts" },
  { id: 4, text: "François Desset's publications on Linear Elamite decipherment — Groundbreaking recent work" },
]} />