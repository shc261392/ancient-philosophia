...
<References references={[
  { id: 1, text: "*Mary Beard, SPQR: A History of Ancient Rome*** — Brilliant modern survey" },
  { id: 2, text: "*Harriet Flower (ed.), The Cambridge Companion to the Roman Republic*** — Academic essays" },
  { id: 3, text: "*Mike Duncan, The Storm Before the Storm*** — The crisis that ended the Republic" },
  { id: 4, text: "LacusCurtius (Bill Thayer) — Digitized ancient texts on Roman history", url: "https://penelope.uchicago.edu/Thayer/E/Roman/home.html" },
