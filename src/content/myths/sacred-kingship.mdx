...
<Cited status="green">
Egyptian kingship was the most theologically absolute form of sacred monarchy. The living pharaoh was not merely chosen by the gods — he *was* a god:<Ref id={1} />
</Cited>
...
- Monumental building (temples as cosmic architecture)<Ref id={4} />
</Cited>

<Cited status="green">
The reciprocal relationship was absolute: the gods maintained the cosmos; the pharaoh maintained *ma'at*; disruption of kingship was disruption of reality itself.<Ref id={1} />
</Cited>
...
<Cited status="yellow">
The Mesopotamian king was emphatically **not** a god (with rare exceptions during the Ur III period, when Shulgi and others were deified). The king was:<Ref id={2} />
</Cited>
...
- **Accountable** to the gods — royal inscriptions routinely present kings as servants, not masters, of their divine patrons<Ref id={1} />
</Cited>
...
6. If the king wept during the humiliation, Marduk was pleased — the year would be prosperous<Ref id={2} />
</Cited>

<Cited status="green">
This annual **ritual humiliation** expressed a theology fundamentally different from Egyptian divine kingship: the Mesopotamian king ruled *at the gods' pleasure* and could be held accountable.<Ref id={1} />
</Cited>
...
<References references={[
  { id: 1, text: "Pyramid Texts / Royal Titulary — Egyptian divine kingship" },
  { id: 2, text: "Code of Hammurabi prologue — Mesopotamian royal ideology" },
  { id: 3, text: "Hittite plague prayers of Mursili II — Royal accountability" },
  { id: 4, text: "Res Gestae Divi Augusti — Roman imperial self-presentation" },
  { id: 5, text: "Dio Cassius — Accounts of imperial consecration" },
]} />