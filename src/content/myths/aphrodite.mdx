...
<Cited status="green">
**Aphrodite** (Greek: Ἀφροδίτη) — goddess of love, sexual desire, beauty, and procreation — was among the most powerful and paradoxical deities of the Greek world. She combined the cosmic force of **Eros** (desire that moves the universe) with intimate human sexuality, military protection with erotic charm, and eastern origins with a thoroughly Greek persona.<Ref id={3} />
</Cited>

<Cited status="yellow">
Her cult was anchored at **Paphos** (Cyprus) and **Kythera** (an island south of the Peloponnese), both waystations on the maritime route from the Levant — geography that mirrors her cultural trajectory from Near Eastern love goddess to Greek Olympian.<Ref id={1} />
</Cited>

## Birth Myths

<Cited status="yellow">
Two incompatible birth narratives existed:<Ref id={1} />
</Cited>
...
<Cited status="yellow">
Aphrodite is the daughter of **Zeus** and **Dione** (an ancient goddess at Dodona). This version domesticates her — she is a younger Olympian, subject to Zeus's authority, and in the *Iliad* she is wounded by Diomedes and scolded by Zeus for meddling in war.<Ref id={2} />
</Cited>
...
<Cited status="green">
This Near Eastern background is explored in detail in the article on [Aphrodite-Astarte-Ishtar](/myths/aphrodite-astarte-ishtar/).<Ref id={3} />
</Cited>
...
<References references={[
  { id: 1, text: "Hesiod, Theogony 188–206 — Birth from Ouranos" },
  { id: 2, text: "Homer, Iliad 5 and Odyssey 8 — Battlefield and bedroom" },
  { id: 3, text: "Homeric Hymn to Aphrodite (5) — Aphrodite and Anchises" },
  { id: 4, text: "Sappho — Fragments, especially Fr. 1 (Hymn to Aphrodite)" },
  { id: 5, text: "Pausanias — Temple and cult descriptions" },
]} />