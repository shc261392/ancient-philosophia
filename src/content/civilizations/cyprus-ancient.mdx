...
- Diplomatic correspondence with Egypt and Ugarit attests to Cyprus's political importance<Ref id={2} />
</Cited>

<Cited status="green">
The Late Bronze Age collapse (c. 1200–1050 BCE) brought disruption but also new settlement, likely including Greek-speaking populations from the Aegean.<Ref id={2} />
</Cited>

## Iron Age: City-Kingdoms (c. 1050–310 BCE)

<Cited status="yellow">
Iron Age Cyprus was organized into a patchwork of independent city-kingdoms, each with its own king:<Ref id={1} />
</Cited>
...
<References references={[
  { id: 1, text: "*A. Bernard Knapp, The Archaeology of Cyprus: From Earliest Prehistory through the Bronze Age*** (2013) — Definitive archaeological survey" },
  { id: 2, text: "*Maria Iacovou (ed.), Cyprus and the Aegean in the Early Iron Age*** (2012) — Transition from Bronze to Iron Age" },
  { id: 3, text: "*Vassos Karageorghis, Ancient Art from Cyprus in the Collection of the Metropolitan Museum*** — Overview of Cypriot material culture" },
  { id: 4, text: "The Cyprus Institute – STARC — Science and technology for archaeological research", url: "https://www.cyi.ac.cy/starc" },
]} />