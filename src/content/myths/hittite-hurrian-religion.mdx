...
<Cited status="green">
The Hittite Empire, centered at **Hattusa** (modern Boğazkale, Turkey), produced one of the most religiously diverse civilizations of the ancient Near East. The Hittites themselves called their gods "the thousand gods of Hatti" — a phrase that captures the extraordinary syncretism of their religious world. Into a single imperial system, they absorbed the deities and rituals of the indigenous Hattian population, the Hurrian civilization of upper Mesopotamia and Syria, Mesopotamian traditions, and their own Indo-European religious heritage.<Ref id={1} />
</Cited>

<Cited status="yellow">
The result was a massive, layered pantheon preserved in thousands of cuneiform tablets from the Hattusa archives — including myths, rituals, prayers, festival descriptions, and oracle texts.<Ref id={1} />
</Cited>
...
<Cited status="yellow">
The supreme deity of the Hittite state was the **Storm God of Hatti** — known as **Tarhunna** in Hittite and **Teshub** in Hurrian. Like his Mesopotamian counterpart Adad and the Canaanite Baal, the Storm God was lord of rain, thunder, and the sky. He was depicted standing on a bull, wielding a mace and thunderbolts. His cult center was at Hattusa itself, where the great temple (Temple I) was dedicated to him and the Sun Goddess.<Ref id={1} />
</Cited>

### The Sun Goddess of Arinna
<Cited status="green">
The **Sun Goddess of Arinna** (*Arinniti*) was the principal female deity of the Hittite state — "Queen of Heaven and Earth, mistress of the kings and queens of Hatti." She was the guarantor of Hittite kingship and military victory. Her identity with Hurrian **Hepat** (consort of Teshub) was formalized in later Hittite religion, visible in the rock reliefs at **Yazılıkaya**.<Ref id={7} />
</Cited>

### Hepat
<Cited status="yellow">
The Hurrian great goddess, consort of Teshub. Hepat was a queenly figure, often shown standing on a lion. Through syncretism with the Sun Goddess of Arinna, she became effectively the supreme goddess of the late Hittite Empire.<Ref id={1} />
</Cited>

### Sharruma
<Cited status="yellow">
Son of Teshub and Hepat. A youthful divine prince, patron of the Hittite king Tudhaliya IV, who is depicted in Sharruma's embrace at Yazılıkaya.<Ref id={1} />
</Cited>

### Kumarbi
<Cited status="green">
The Hurrian father of the gods — a figure of immense mythological importance. Kumarbi's role in the succession myth makes him the Hurrian analogue of Greek Kronos. See the Song of Kumarbi below.<Ref id={7} />
</Cited>

### Telepinu
<Cited status="yellow">
The disappearing god — a deity of agriculture whose absence causes famine and desolation. The **Myth of Telepinu** narrates his anger, withdrawal, and eventual appeasement through ritual — a pattern common to several Hittite "missing god" myths.<Ref id={3} />
</Cited>

### Lelwani
<Cited status="yellow">
Originally a male deity, later a goddess — ruler of the underworld in the Hittite tradition.<Ref id={1} />
</Cited>
...
<References references={[
  { id: 1, text: "Trevor Bryce, Life and Society in the Hittite World (2002) — Comprehensive social history including religion" },
  { id: 2, text: "Gary Beckman, \"The Religion of the Hittites\" in Biblical Archaeologist 52 (1989) — Essential overview" },
  { id: 3, text: "Harry A. Hoffner Jr. and Gary Beckman, Hittite Myths (2nd ed., 1998) — Standard English translations" },
  { id: 4, text: "Billie Jean Collins, The Hittites and Their World (2007) — Accessible introduction" },
  { id: 5, text: "Jörg Klinger, Die hethitische Mythologie und ihre vorderasiatischen und griechischen Parallelen (2017)" },
  { id: 6, text: "Hethitologie Portal Mainz — Digital Hittitology resources", url: "https://www.hethport.uni-wuerzburg.de/" },
  { id: 7, text: "Song of Kumarbi (Kingship in Heaven) — Hurrian succession myth (CTH 344)" },
  { id: 8, text: "Song of LAMMA / Song of Hedammu / Song of Ullikummi — Related Kumarbi cycle texts" },
]} />