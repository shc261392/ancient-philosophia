...
<Cited status="green">
Thoth was a lunar deity — the moon was his celestial form. The Egyptian calendar divided time by lunar months, and Thoth was lord of this reckoning. The myth of the **Gambling of Thoth** relates how he won five extra days from the moon in a game of *senet*, adding them to the 360-day calendar to create the five epagomenal days — the birthdays of Osiris, Horus the Elder, Set, Isis, and Nephthys.<Ref id={2} />
</Cited>

### Magic (*ḥkꜣ*)

<Cited status="green">
Thoth was the supreme magical practitioner. He healed the Eye of Horus after Set damaged it. He protected Isis and Horus in the marshes. His magical formulas were the basis of the *Books of Breathing* (Late Period funerary texts) — successors to the *Book of the Dead*.<Ref id={3} />
</Cited>

### Judgment and Record-Keeping

<Cited status="green">
In the **Weighing of the Heart** ceremony, Thoth stands beside the scales recording the verdict. His role as divine scribe made him the guarantor of truth — the secretary of *ma'at*. In the *Contendings of Horus and Set*, Thoth serves as the voice of reason in the divine tribunal, drafting letters and proposing compromises.<Ref id={2} />
</Cited>
...
<References references={[
  { id: 1, text: "Pyramid Texts — Thoth as protector and recorder" },
  { id: 2, text: "Contendings of Horus and Set — Thoth as mediator" },
  { id: 3, text: "Book of the Dead Chapter 125 — Thoth at the Weighing" },
  { id: 4, text: "Corpus Hermeticum (2nd–3rd century CE) — Hermetic dialogues" },
]} />