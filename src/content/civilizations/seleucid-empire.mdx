...
<Cited status="green">
The Seleucids were prolific city founders. Their greatest creation was **Antioch on the Orontes** (modern Antakya, Turkey), the imperial capital and eventually one of the largest cities in the Roman world. Other major foundations include:<Ref id={2} />
</Cited>
...
- **Ai-Khanoum** (possibly Alexandria on the Oxus) — A fully Greek city in northern Afghanistan, with gymnasium, theater, and Greek philosophical inscriptions<Ref id={3} />
</Cited>

## Greek-Babylonian Cultural Fusion

<Cited status="green">
The Seleucid era produced remarkable cultural hybridity, nowhere more evident than in Mesopotamia:<Ref id={4} />
</Cited>
...
<References references={[
  { id: 1, text: "*John D. Grainger, The Seleukid Empire of Antiochus III*** (2015) — Detailed political history" },
  { id: 2, text: "*Susan Sherwin-White and Amélie Kuhrt, From Samarkhand to Sardis*** (1993) — Groundbreaking study of the Seleucid relationship with Near Eastern traditions" },
  { id: 3, text: "*Peter Green, Alexander to Actium*** (1990) — Comprehensive Hellenistic narrative" },
  { id: 4, text: "ORACC: Astronomical Diaries — Babylonian astronomical texts from the Seleucid period", url: "https://oracc.museum.upenn.edu/adsd/" },
  { id: 5, text: "Livius.org: Seleucid Empire — Accessible overview with maps and primary source translations", url: "https://www.livius.org/articles/dynasty/seleucids/" },
]} />