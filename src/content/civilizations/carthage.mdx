...
<References references={[
  { id: 1, text: "*Dexter Hoyos, The Carthaginians*** (2010) — Comprehensive modern overview" },
  { id: 2, text: "*Adrian Goldsworthy, The Fall of Carthage*** (2003) — Military history of the Punic Wars" },
  { id: 3, text: "*Richard Miles, Carthage Must Be Destroyed*** (2010) — Narrative history of the city and its conflict with Rome" },
  { id: 4, text: "The Carthage Museum (Musée National de Carthage) — Archaeological collections from the site", url: "https://www.inp.rnrt.tn/" },
  { id: 5, text: "*Serge Lancel, Carthage: A History*** (1995) — Scholarly history drawing on French excavations" },
]} />