...
<Cited status="red">
The Greek alphabet, adopted from the Phoenician consonantal script around 800 BCE (with the crucial addition of vowel letters), is the ancestor of the Latin and Cyrillic alphabets:
</Cited>
...
<Cited status="red">
Greek also uses **breathing marks** (rough ʽ = /h/, smooth ʼ = ∅) and **accent marks** (acute, grave, circumflex) indicating pitch accent.
</Cited>
...
- **Word order** — Relatively free, with emphasis on the first and last positions in a clause
</Cited>
