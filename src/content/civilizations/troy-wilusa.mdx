...
<References references={[
  { id: 1, text: "*Eric Cline, The Trojan War: A Very Short Introduction*** — Balanced scholarly overview" },
  { id: 2, text: "*Manfred Korfmann, Troia/Wilusa Guidebook*** — By the lead excavator of the modern campaigns" },
  { id: 3, text: "*Joachim Latacz, Troy and Homer*** — Argues for the historicity of the Trojan War" },
  { id: 4, text: "*Caroline Alexander, The War That Killed Achilles*** — Literary analysis of the Iliad" },
  { id: 5, text: "Troia Project (Universität Tübingen) — Excavation data and publications", url: "https://www.uni-tuebingen.de/troia/" },
]} />