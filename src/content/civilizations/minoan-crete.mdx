...
<Cited status="red">
The Minoan civilization, named by Sir Arthur Evans after the legendary King Minos, was Europe's first advanced civilization. Centered on the island of Crete in the southern Aegean, the Minoans built elaborate palatial complexes, created vibrant frescoes, developed extensive trade networks across the Mediterranean, and employed at least two writing systems — of which **Linear A** remains undeciphered.
</Cited>
