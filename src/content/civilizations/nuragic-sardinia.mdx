...
<Cited status="green">
The Nuragic civilization of Sardinia is one of the most distinctive and enigmatic cultures of prehistoric Europe. Named after the *nuraghi* — massive stone tower-fortresses unique to the island — this civilization flourished for over 1,500 years without producing a deciphered writing system. What survives is an extraordinary archaeological record: over 7,000 nuraghi, elaborate bronze figurines, monumental tombs, and sacred water temples that attest to a complex, prosperous society deeply connected to wider Mediterranean networks.<Ref id={5} />
</Cited>
...
<Cited status="green">
Nuragic funerary and religious architecture was equally impressive:<Ref id={3} />
</Cited>
...
- These ritual sites suggest a religion centered on water, fertility, and perhaps celestial observation<Ref id={1} />
</Cited>
...
<References references={[
  { id: 1, text: "*Gary S. Webster, A Prehistory of Sardinia: 2300–500 BC*** (2015) — Comprehensive archaeological overview" },
  { id: 2, text: "*Miriam S. Balmuth (ed.), Studies in Sardinian Archaeology*** — Key scholarly essays" },
  { id: 3, text: "UNESCO World Heritage: Su Nuraxi di Barumini — The most famous Nuragic complex" },
  { id: 4, text: "Museo Archeologico Nazionale di Cagliari — Houses the largest collection of bronzetti", url: "https://museoarcheologicocagliari.beniculturali.it/" },
  { id: 5, text: "*Emma Blake, Social Networks and Regional Identity in Bronze Age Italy*** (2014) — Nuragic Sardinia in Mediterranean context" },
]} />