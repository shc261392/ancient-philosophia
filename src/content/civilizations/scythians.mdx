...
- **Women warriors** — Herodotus described the **Amazons** as related to the Scythians, and archaeological evidence increasingly confirms that Scythian women were buried with weapons and horse equipment<Ref id={2} />
</Cited>

## The Kurgans: Royal Tombs

<Cited status="green">
The most spectacular evidence of Scythian culture comes from the **kurgans** — massive burial mounds containing royal tombs with astounding grave goods:<Ref id={4} />
</Cited>
...
- **Arzhan** (Tuva, Siberia) — Among the earliest Scythian royal burials (c. 800 BCE)<Ref id={3} />
</Cited>
...
<References references={[
  { id: 1, text: "*Herodotus, Histories Book IV* (Landmark edition, ed. Strassler) — The essential primary source" },
  { id: 2, text: "*Barry Cunliffe, The Scythians: Nomad Warriors of the Steppe*** (2019) — Accessible modern overview" },
  { id: 3, text: "*Renate Rolle, The World of the Scythians*** (1989) — Classic archaeological synthesis" },
  { id: 4, text: "The Hermitage Museum, St. Petersburg: Scythian Gold — Houses the Pazyryk finds and major gold collections", url: "https://www.hermitagemuseum.org/" },
  { id: 5, text: "British Museum: Scythians Exhibition — Featured the 2017 landmark exhibition", url: "https://www.britishmuseum.org/" },
]} />