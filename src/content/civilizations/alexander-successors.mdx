...
<References references={[
  { id: 1, text: "*Robin Lane Fox, Alexander the Great*** — Vivid biography" },
  { id: 2, text: "*Peter Green, Alexander to Actium: The Historical Evolution of the Hellenistic Age*** — Magisterial survey" },
  { id: 3, text: "*Waldemar Heckel, Who's Who in the Age of Alexander the Great*** — Comprehensive prosopography" },
